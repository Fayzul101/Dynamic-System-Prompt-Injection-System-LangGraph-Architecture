...
knowledge_base_dir = os.path.join(script_dir, "--Company knowledge Files Directory Name--")
...
vector_store = Chroma.from_documents(
    ...
    persist_directory = "--Your Knowlege Base Directory Name that will be created--"
)
